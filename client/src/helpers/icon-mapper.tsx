...
const iconMap: { [key: string]: React.ReactNode } = {
    ...
    "Plotly": <SiPlotly />,
    "Matplotlib": <FaChartArea />, // Fallback: SiMatplotlib not in this version of react-icons
    "Seaborn": <FaChartBar /> // Fallback: SiSeaborn not in this version of react-icons
};
